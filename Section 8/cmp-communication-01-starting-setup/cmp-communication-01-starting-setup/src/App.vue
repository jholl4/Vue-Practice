<template>
  <section>
    ...
    <new-friend key="friendForm" @add-friend-to-list="onAddFriendToList"></new-friend>
    <ul>
...
export default {
  ...
  methods: {
    ...
    onAddFriendToList(newFriendToAdd) {
      newFriendToAdd.id = new Date().toISOString();
      newFriendToAdd.isFavorite = true;
      this.friends.push(newFriendToAdd);
    }
  },
};
</script>
